...
## [0.1.2](https://github.com/OxideAV/oxideav-prores/compare/v0.1.1...v0.1.2) - 2026-09-01

### Other

- hide internal pub surface from rustdoc/semver (fleet rule 2026-09-01)

## [0.1.1](https://github.com/OxideAV/oxideav-prores/compare/v0.1.0...v0.1.1) - 2026-07-19
...
- crate-root fourcc_for_profile() — inverse of profile_for_fourcc (RDD 36 carriage)
- typed accessor SliceHeader::qscale() for RDD 36 §7.3 Table 15
- surface RDD 36 §6.1.1 encoder_identifier on the parsed FrameHeader
- RDD 36 §5.1.2 / §6.1.2 stuffing() emission for constant-frame-size carriage
